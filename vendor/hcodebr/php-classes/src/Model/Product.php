...
class Product extends Model
{
    ...
    public function save()
    {
        ...
        $results = $sql->select("call sp_products_save(
            ...
            :vlweight,
            :desurl)", array(
            ":idproduct"=>$this->getidproduct(), // na sp_categories_save se não passar o :idcategory ele considera INSERT ao invés de UPDATE
    ...
    public function getValues() //sobrescrevendo metodo getValues
    {
        $this->checkPhoto();
